 ...
 * @author aperalta
 */
public class selPenya extends javax.swing.JDialog {

    /**
     * Creates new form selPenya
     */
    public selPenya(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
        ...
        this.jTableArrayList1.setList(InterpenyasRubielos.pym.getLista());
    }
    ...
    private void jTableArrayList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableArrayList1MouseClicked
       this.penya =(Penyas) this.jTableArrayList1.getSelectElement();
       this.dispose();
    }//GEN-LAST:event_jTableArrayList1MouseClicked
    public Penyas showSelPenya(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(selPenya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                selPenya dialog = new selPenya(new javax.swing.JFrame());
